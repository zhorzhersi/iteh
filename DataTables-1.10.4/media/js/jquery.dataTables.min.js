...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Prva",sLast:"Poslednja",sNext:"Sledeca",sPrevious:"Prethodna"},sEmptyTable:"Nema podataka u tabeli",sInfo:"Prikazano od _START_ do _END_ od ukupno _TOTAL_ unosa",sInfoEmpty:"Prikazano 0 do 0 od 0 unosa",sInfoFiltered:"(filtrirano od ukupno _MAX_ unosa)",sInfoPostFix:"",sDecimal:"",
sThousands:",",sLengthMenu:"Prikazi _MENU_ unosa",sLoadingRecords:"Ucitavam...",sProcessing:"Procesiram...",sSearch:"Pretraga:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Nema zadatog pojma"},oSearch:g.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null};V(p.defaults);p.defaults.column={aDataSort:null,iDataSort:-1,asSorting:["asc","desc"],bSearchable:!0,
